    ...
    <Box sx={{ height: "100vh", overflowY: "auto" }}>
      ...
      <Box sx={{ padding: { xs: '5%', md: '5%' } }}>
        <Box sx={{ padding: '5% 0' }}>
          ...
          <img className="sample_image" src="example_repair.png" alt="" style={{ width: '100%', height: 'auto' }} />
        </Box>
        ...
        <Box sx={{ padding: '5% 0' }}>
          ...
          <Box className="text_contents" sx={{ padding: '2%' }}>
            ...
            <p>メリット２<br />
              キズ補修と調色を行うので違和感を最小限に抑えることができる。<br />
              フローリングや建具などは、築年数とともに色あせてしまいます。フローリングを１枚だけ新品に交換するとその部分だけ違和感が出てしまうことも。違和感が出ないようにリフォームするとなれば時間もコストもとてもかかります。その点リペアはコストも時間も最小限にできます。<br />
            </p>
            <p>メリット３<br />
              物を大切にし環境にも優しい！まさにSDGｓ！<br />
              物を大切にしましょう！小さいころ、親や学校の先生からよくいわれました。こわれたら修理し、汚れたら洗ったりみがいたりして物を大切に長く利用する。長く利用すると愛着が湧きかけがえのないものになっていきますよね。家もそうあって欲しいと私は思います。<br />
            </p>
            <p>デメリット１<br />
              ニオイや換気<br />
              リペア作業は、シンナーなどの有機溶剤を使用しますのでニオイが発生してしまいます。十分な換気が必要となりますのでご了承ください。ニオイに敏感な方は特に注意が必要です。<br />
              有機溶剤は、接着剤などにも含まれますのでリペアだけでなく部材交換（リフォーム）でも発生する場合があります。<br />
            </p>
            <p>デメリット２<br />
              リペアが厳しいところ<br />
              ドアのヒンジなどの可動部や広範囲のキズには不向きです。その場合には交換をおすすめいたします。<br />
            </p>
          </Box>
        </Box>
